...
* Update 1/25/09 - to include additional style hooks, properties, and deal with IE browsers with filters disabled.
***********************************************/
...
this.count_sep = typeof imgs.count_sep == 'undefined'? ' /' : imgs.count_sep;
if (!this.dom){
